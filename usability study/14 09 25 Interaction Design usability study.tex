...
% JD: This section needs better markup for readability when processed by LaTeX.
...
% JD: The above analysis is reasonable with one problem: it is done in isolation.
%     What do relevant guidelines documents say about touch-and-hold?  Are there
%     such guidelines?  Are any of these gestures standard in the platform?  There
%     is a need here to perform this analysis in the context of the information that
%     is available to you.
...
% JD: This paragraph is good, and would be better if we have specific timing numbers
%     on that hold delay.
...
% JD: Same issue---this is an observation you make in isolation.  What do pertinent
%     user interface documents say about how this layout should be done?
...
% JD: This is a particularly cogent observation, and it is nice that you tested the
%     full spelling to verify your hypothesis.  Still, what principle does this call
%     out?  You got the mental model connection nicely; next you should be able to
%     spot a principle that exemplifies this connection.
